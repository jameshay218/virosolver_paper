...
#SBATCH -t 0-23:59          # Runtime in D-HH:MM, minimum of 10 minutes
...
R CMD BATCH --quiet --no-restore --no-save 2.sim_nursing_homes/2.simulated_nursing_homes.R jobout/${SLURM_JOB_NAME}/OutSim_${SLURM_ARRAY_TASK_ID}.Rout
