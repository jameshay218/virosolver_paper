#!/bin/bash
#SBATCH -J CHANGING_TESTING_RERUN
...
R CMD BATCH --quiet --no-restore --no-save 3.testing_capcity/3.changing_test_rates.R jobout/${SLURM_JOB_NAME}/changing_testing_${SLURM_ARRAY_TASK_ID}.Rout
