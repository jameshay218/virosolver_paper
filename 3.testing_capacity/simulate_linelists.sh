...
R CMD BATCH --quiet --no-restore --no-save 3.testing_capacity/3.symptomatic_testing_simulate_linelists.R jobout/${SLURM_JOB_NAME}/Testing_simulate_linelists_${SLURM_ARRAY_TASK_ID}.Rout
