...
R CMD BATCH --quiet --no-restore --no-save 3.testing_capacity/3.symptomatic_testing_virosolver_new.R jobout/${SLURM_JOB_NAME}/Testing_VIRO_${SLURM_ARRAY_TASK_ID}.Rout
