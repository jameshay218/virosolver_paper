...
if(SAVE_PLOTS){
  if(run_ver == "bwh"){
    ggsave("figures/supplement/viral_kinetics_bwh_lower_sens.pdf",p_main,height=6,width=8)
    ggsave("figures/supplement/viral_kinetics_bwh_lower_sens.png",p_main,height=6,width=8)
    parTab$values <- pars1
    #write_csv(parTab,"pars/partab_fitted_bwh.csv")
  } else {
    ggsave("figures/supplement/viral_kinetics_nh_lower_sens.pdf",p_main,height=6,width=8)
    ggsave("figures/supplement/viral_kinetics_nh_lower_sens.png",p_main,height=6,width=8)
    parTab$values <- pars1
