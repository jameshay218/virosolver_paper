...
mcmcPars_ct <- c("iterations"=700000,"popt"=0.44,"opt_freq"=1000,
                 "thin"=10,"adaptive_period"=300000,"save_block"=1000)
...
parTab[parTab$names %in% c("viral_peak","obs_sd","t_switch","level_switch","wane_rate2","prob_detect"), "fixed"] <- 1
