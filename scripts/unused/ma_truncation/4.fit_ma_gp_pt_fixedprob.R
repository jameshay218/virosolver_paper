...
parTab[parTab$names == "prob_detect", "fixed"] <- 1
...
chains_diag <- lazymcmc::load_mcmc_chains(chainwd, parTab,TRUE,1,mcmcPars_ct["adaptive_period"],
                                     multi=FALSE,chainNo=FALSE,PTchain = TRUE)
...
chains <- lazymcmc::load_mcmc_chains(chainwd, parTab,FALSE,1,mcmcPars_ct["adaptive_period"],
                                      multi=FALSE,chainNo=TRUE,PTchain = TRUE)
...
#pdf("figures/ma_new2.pdf",height=7,width=8)
#p_nyt/p_dat/p_inc  
#dev.off()
